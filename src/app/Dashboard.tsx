import { RefreshCw, Filter, TrendingUp, Briefcase, Building2, Lightbulb, ArrowUpRight, ArrowDownRight, Minus, Sparkles, ChevronDown, Calendar, Video, Users, MapPin, Clock, ChevronUp, ExternalLink, Radar, Zap } from 'lucide-react';
import { Button } from './components/ui/button';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from './components/ui/select';
import { useState, useEffect } from 'react';
import { PieChart, Pie, Cell, Tooltip, ResponsiveContainer, BarChart, Bar, XAxis, YAxis, LineChart, Line, CartesianGrid, Treemap, Legend, Area, AreaChart } from 'recharts';
...
export default function Dashboard() {
  ...
  // Handler for navigating to Fund page with asset class
  ...
  // Enhanced Market News Data with comprehensive categorization
  const newsItems: NewsItem[] = [
    { 
      id: '1', 
      icon: '📈', 
      text: 'NVIDIA announces breakthrough in AI chip efficiency, stock surges 8% in pre-market trading', 
      fullText: 'NVIDIA announces breakthrough in AI chip efficiency, stock surges 8% in pre-market trading. The semiconductor giant unveiled its latest generation of processors featuring a revolutionary architecture that delivers 40% better performance per watt. Industry analysts predict this could accelerate AI adoption across enterprise markets. Major cloud providers including AWS, Azure, and Google Cloud have already placed preliminary orders. The stock jumped to $850 in pre-market trading, pushing the company\'s market cap past $2.1 trillion.',
      category: 'general', 
      tags: ['tech', 'equities', 'ai'], 
      timeAgo: '2 hours ago', 
      source: 'Bloomberg', 
      popularity: 98,
      macroTheme: 'Technology Innovation',
      assetClass: 'Equities',
    ...
    { 
      ...
      fullText: 'Oil prices jump 6% as OPEC+ announces unexpected production cuts. Brent crude surged to $89 per barrel following the announcement of additional supply restrictions totaling 1.5 million barrels per day. The decision came as a surprise to energy markets, with several OPEC+ members citing the need to stabilize prices amid concerns over global economic growth. Energy sector equities rallied in response, with major oil companies seeing significant gains. Analysts warn this could put upward pressure on inflation just as central banks consider rate policy adjustments.',
      category: 'commodities', 
      tags: ['oil', 'commodities', 'opec'], 
      timeAgo: '1 hour ago', 
      source: 'Reuters', 
      popularity: 95,
      macroTheme: 'Energy Markets',
    ...
    { 
      ...
      fullText: 'Federal Reserve signals potential rate cuts in Q2 2026, markets rally. In today\'s policy statement, the Fed acknowledged progress on inflation targets while noting softening in certain economic indicators. Chairman Powell suggested that if trends continue, the committee could begin easing monetary policy as early as the second quarter. Treasury yields fell sharply across the curve, with the 10-year note dropping 15 basis points to 3.85%. Equity markets responded positively, with the S&P 500 gaining 1.8% and the Nasdaq jumping 2.3%. Credit markets also tightened, signaling improved risk appetite among investors.',
      category: 'global', 
      tags: ['fed', 'rates', 'policy'], 
      timeAgo: '3 hours ago', 
      source: 'Financial Times', 
      popularity: 100,
      macroTheme: 'Monetary Policy',
    ...
    { 
      ...
      fullText: 'Tesla beats Q1 delivery estimates, stock up 12% after hours. The electric vehicle manufacturer reported deliveries of 485,000 vehicles, well above analyst expectations of 445,000. Strong demand in China and Europe offset slower growth in North America. The company also announced plans to expand production capacity at its Texas and Berlin factories. CEO Elon Musk indicated on the earnings call that new battery technology could reduce costs by 25% starting in 2027. The automotive sector rallied in sympathy, with traditional automakers with EV programs also seeing gains.',
      category: 'general', 
      tags: ['tesla', 'ev', 'earnings'], 
      timeAgo: '4 hours ago', 
      source: 'CNBC', 
      popularity: 92,
      macroTheme: 'Electric Vehicles',
      assetClass: 'Equities',
      country: 'United States',
      region: 'North America',
    ...
    { 
      ...
      fullText: 'Wheat prices surge 8% on supply concerns from Black Sea region. Chicago wheat futures climbed to a three-month high amid reports of adverse weather affecting crop conditions in Ukraine and southern Russia. Agricultural analysts estimate a potential 15% reduction in spring wheat yields. The price spike has raised concerns about food security in import-dependent nations across Africa and the Middle East. Corn and soybean prices also moved higher in sympathy trading. Agricultural commodity ETFs saw strong inflows as investors sought inflation hedges.',
      category: 'commodities', 
      tags: ['wheat', 'agriculture', 'supply'], 
      timeAgo: '5 hours ago', 
      source: 'Wall Street Journal', 
      popularity: 78,
      macroTheme: 'Agriculture',
      assetClass: 'Commodities',
      country: 'Global',
      region: 'Global',
      sector: 'Agriculture'
    ...
    { 
      ...
      fullText: 'Gold reaches new all-time high above $2,500/oz on safe-haven demand. The precious metal broke through key resistance levels as investors sought protection against geopolitical uncertainties and currency volatility. Central bank purchases remained strong, particularly from emerging market economies diversifying reserves. Silver followed gold higher, gaining 4% to trade at $29.50/oz. Mining stocks outperformed with the VanEck Gold Miners ETF up 5.5%. Analysts note that gold\'s strength comes despite relatively high real interest rates, suggesting robust underlying demand.',
      category: 'commodities', 
      tags: ['gold', 'safe-haven', 'metals'], 
      timeAgo: '6 hours ago', 
      source: 'Bloomberg', 
      popularity: 88,
      macroTheme: 'Safe Haven Assets',
      assetClass: 'Commodities',
      country: 'Global',
      region: 'Global',
      sector: 'Materials'
    ...
    { 
      ...
      fullText: 'JPMorgan reports record quarterly profit, raises dividend 10%. The banking giant posted earnings of $4.25 per share, beating estimates by 15 cents. Strong performance across investment banking and wealth management divisions more than offset challenges in retail banking. Net interest income remained robust despite expectations of rate cuts. The company also announced a $15 billion share buyback program. CEO Jamie Dimon expressed cautious optimism about the economic outlook while noting continued strength in consumer balance sheets. Bank stocks rallied broadly on the news.',
      category: 'general', 
      tags: ['banks', 'earnings', 'financials'], 
      timeAgo: '7 hours ago', 
      source: 'Reuters', 
      popularity: 85,
      macroTheme: 'Banking',
    ...
    { 
      ...
      fullText: 'European Central Bank holds rates steady, signals data-dependent approach. President Lagarde emphasized the need for continued vigilance on inflation despite recent moderation. The ECB maintained its deposit rate at 3.75% while updating economic projections. Growth forecasts for the Eurozone were revised lower to 1.2% for 2026, reflecting persistent weakness in manufacturing. The euro weakened slightly against the dollar following the announcement. Bond markets showed muted reaction as the decision was widely anticipated. Focus now shifts to upcoming inflation data to gauge timing of potential rate cuts.',
      category: 'global', 
      tags: ['ecb', 'europe', 'rates'], 
      timeAgo: '8 hours ago', 
      source: 'Financial Times', 
      popularity: 82,
      macroTheme: 'Monetary Policy',
  ...
  const upcomingEvents = [
    {
      id: '1',
      company: 'M&G presentation',
      event: 'Quarterly Business Review',
      date: 'Feb 15',
      time: '10:00 EST',
      location: 'Virtual',
      notes: 'Prepare Q4 performance deck',
      color: '#3B82F6'
    },
    {
      id: '2',
      company: 'New client call',
      event: 'Portfolio Strategy Session',
      date: 'Feb 18',
      time: '14:30 EST',
      location: 'On-Site (London)',
      notes: 'Discuss ESG integration',
      color: '#10B981'
    },
    {
      id: '3',
      company: 'Client follow up',
      event: 'Annual Investment Committee',
      date: 'Feb 20',
      time: '09:00 EST',
      location: 'Virtual',
      notes: 'Review fee structure',
      color: '#8B5CF6'
    },
    {
      id: '4',
      company: 'Weekly update',
      event: 'Risk Management Workshop',
      date: 'Feb 25',
      time: '11:00 EST',
      location: 'Virtual',
      notes: 'VaR model updates',
      color: '#F59E0B'
    },
    {
      id: '5',
      company: 'Risk Committee',
      event: 'Technology Integration Meeting',
      date: 'Feb 28',
      time: '13:00 EST',
      location: 'On-Site (London)',
      notes: 'API connectivity review',
      color: '#EF4444'
    }
  ];
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-[#111827] border border-gray-800 rounded-lg overflow-hidden flex flex-col">
        <div className="px-6 py-4 border-b border-gray-800 flex items-center justify-between bg-[#0F1621]">
          ...
          <Button 
            variant="outline" 
            className="border-gray-800 bg-gray-900/50 hover:bg-gray-800 text-blue-400 text-xs font-bold"
      ...
      <div className="bg-[#111827] border border-gray-800 rounded-lg p-6">
        ...
        <div className="space-y-0">
          {upcomingEvents.map((event) => (
            <div 
              key={event.id}
              className="grid grid-cols-[0.5fr_1.5fr_1fr_1fr_1.5fr_0.7fr] gap-4 px-4 py-4 border-b border-gray-800 hover:bg-[#0D1525] transition-colors cursor-pointer items-center"
            >
